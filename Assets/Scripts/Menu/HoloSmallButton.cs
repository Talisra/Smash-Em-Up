...
public class HoloSmallButton : MonoBehaviour
{
    public string description;
    public int action; // the action is handled by the parent component
    public GameObject buttonAnchor;
    public Text text;
    public Renderer rendScreen;
    public List<Renderer> rendSticklight;

    private YesNoDialog parentDialog;
    ...
    private void Start()
    {
        parentDialog = GetComponentInParent<YesNoDialog>();
